      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-4xl font-display font-bold uppercase tracking-tighter text-white">
            Full <span className="text-purple-500">Logistics</span>
          </h1>
          <p className="text-zinc-500 font-medium mt-1 uppercase text-[10px] tracking-widest">Global deployment and event oversight</p>
        </div>
        <Button 
                      ...
                      <td className="px-8 py-6 text-right">
                        <div className="flex items-center justify-end gap-2">
                           <Link href={`/admin/events/${event.id}`} onClick={(e) => e.stopPropagation()}>
                              <Button size="icon" variant="ghost" className="rounded-xl border border-white/5 hover:bg-purple-500 hover:text-white transition-all">
                                 <ChevronRight className="size-4" />
                              </Button>
                           </Link>
                           <Button size="icon" variant="ghost" className="rounded-xl border border-white/5 hover:bg-white/10 text-zinc-500 hover:text-white transition-all">
                           ...
                           <Button 
                             ...
                             className="rounded-xl border border-white/5 hover:bg-red-500/20 text-zinc-500 hover:text-red-500 transition-all"
                           >
